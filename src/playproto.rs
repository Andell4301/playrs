...
pub struct AcquireRequest {
    ...
    pub package: ::core::option::Option<acquire_request::Package>,
    #[prost(message, optional, tag = "8")]
    pub f8: ::core::option::Option<Field>,
    #[prost(message, optional, tag = "12")]
    pub version: ::core::option::Option<acquire_request::Version>,
    #[prost(uint32, optional, tag = "13")]
    pub offer_type: ::core::option::Option<u32>,
    #[prost(uint32, optional, tag = "15")]
    pub f15: ::core::option::Option<u32>,
    #[prost(string, optional, tag = "22")]
    pub nonce: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(uint32, optional, tag = "25")]
    pub f25: ::core::option::Option<u32>,
    #[prost(message, optional, tag = "30")]
    pub m30: ::core::option::Option<acquire_request::Message30>,
}
...
pub mod acquire_request {
    ...
    pub struct Package {
        #[prost(message, optional, tag = "1")]
        pub payload: ::core::option::Option<package::Payload>,
        #[prost(uint32, optional, tag = "2")]
        pub f2: ::core::option::Option<u32>,
    }
...
pub struct AcquireResponseWrapper {
    #[prost(message, optional, tag = "1")]
    pub acquire_response: ::core::option::Option<
        acquire_response_wrapper::AcquireResponse,
    >,
}
/// Nested message and enum types in `AcquireResponseWrapper`.
pub mod acquire_response_wrapper {
    #[allow(dead_code)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct AcquireResponse {
        #[prost(message, optional, tag = "94")]
        pub acquire_payload: ::core::option::Option<acquire_response::AcquirePayload>,
    }
    /// Nested message and enum types in `AcquireResponse`.
    pub mod acquire_response {
        #[allow(dead_code)]
        #[derive(serde::Serialize, serde::Deserialize)]
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct AcquirePayload {
            #[prost(message, optional, tag = "3")]
            pub purchase: ::core::option::Option<acquire_payload::PurchaseWrapper>,
            #[prost(message, optional, tag = "4")]
            pub package: ::core::option::Option<acquire_payload::Package>,
        }
        /// Nested message and enum types in `AcquirePayload`.
        pub mod acquire_payload {
            #[allow(dead_code)]
            #[derive(serde::Serialize, serde::Deserialize)]
            #[derive(Clone, PartialEq, ::prost::Message)]
            pub struct PurchaseWrapper {
                #[prost(int32, optional, tag = "7")]
                pub status: ::core::option::Option<i32>,
                #[prost(message, optional, tag = "8")]
                pub m8: ::core::option::Option<purchase_wrapper::Message8>,
                #[prost(string, optional, tag = "9")]
                pub signature: ::core::option::Option<::prost::alloc::string::String>,
                #[prost(message, optional, tag = "10")]
                pub response: ::core::option::Option<super::Response>,
                #[prost(oneof = "purchase_wrapper::PurchaseOneOf", tags = "12, 15")]
                pub purchase_one_of: ::core::option::Option<
                    purchase_wrapper::PurchaseOneOf,
                >,
            }
            /// Nested message and enum types in `PurchaseWrapper`.
            pub mod purchase_wrapper {
                #[allow(dead_code)]
                #[derive(serde::Serialize, serde::Deserialize)]
                #[derive(Clone, PartialEq, ::prost::Message)]
                pub struct Purchase {
                    ...
                    pub properties: ::core::option::Option<purchase::Properties>,
                }
                /// Nested message and enum types in `Purchase`.
                pub mod purchase {
                    #[allow(dead_code)]
                    #[derive(serde::Serialize, serde::Deserialize)]
                    #[derive(Clone, PartialEq, ::prost::Message)]
                    ...
                    pub struct Entry {
                        ...
                        #[prost(oneof = "entry::DataOneOf", tags = "2, 4")]
                        pub data_one_of: ::core::option::Option<entry::DataOneOf>,
                    }
                    ...
                    pub mod entry {
                        ...
                        pub enum DataOneOf {
                            #[prost(string, tag = "2")]
                            BoolValue(::prost::alloc::string::String),
                            #[prost(int32, tag = "4")]
                            IntValue(i32),
                        }
                    }
                ...
                pub struct Message8 {
                    #[prost(message, repeated, tag = "1")]
                    pub some_things: ::prost::alloc::vec::Vec<SomeThing>,
                }
                #[allow(dead_code)]
                #[derive(serde::Serialize, serde::Deserialize)]
                #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
                pub struct SomeThing {
                    ...
                    pub f1: ::core::option::Option<i32>,
                    #[prost(int32, optional, tag = "2")]
                    pub f2: ::core::option::Option<i32>,
                    #[prost(message, optional, tag = "3")]
                    pub f3: ::core::option::Option<super::super::super::super::Field>,
                    #[prost(message, optional, tag = "4")]
                    pub f4: ::core::option::Option<super::super::super::super::Field>,
                    #[prost(string, optional, tag = "6")]
                    pub f6: ::core::option::Option<::prost::alloc::string::String>,
                }
                #[allow(dead_code)]
                #[derive(serde::Serialize, serde::Deserialize)]
                #[derive(Clone, PartialEq, ::prost::Oneof)]
                pub enum PurchaseOneOf {
            ...
            pub struct Package {
                #[prost(message, optional, tag = "1")]
                pub payload: ::core::option::Option<package::OuterPayload>,
            }
            /// Nested message and enum types in `Package`.
            pub mod package {
                #[allow(dead_code)]
                ...
                pub struct OuterPayload {
                    ...
                    #[prost(message, optional, tag = "2")]
                    pub encoded_payload: ::core::option::Option<EncodedPayload>,
                    #[prost(message, optional, tag = "5")]
                    pub sub_payload: ::core::option::Option<InnerPayload>,
                }
                #[allow(dead_code)]
                #[derive(serde::Serialize, serde::Deserialize)]
                #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
                ...
                pub struct AppInfo {
                    #[prost(string, optional, tag = "1")]
                    pub package_name: ::core::option::Option<
                        ::prost::alloc::string::String,
                    >,
                    #[prost(uint64, optional, tag = "2")]
                    pub seven: ::core::option::Option<u64>,
                }
                #[allow(dead_code)]
                #[derive(serde::Serialize, serde::Deserialize)]
                #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
                pub struct EncodedPayload {
                    #[prost(string, optional, tag = "1")]
                    pub encoded: ::core::option::Option<::prost::alloc::string::String>,
                }
            }
        }
        #[allow(dead_code)]
        ...
        pub mod response {
            ...
            pub struct Payload {
                #[prost(message, optional, tag = "1")]
                pub data: ::core::option::Option<payload::Data>,
            }
...
pub struct RentalTerms {
    #[prost(int32, optional, tag = "1")]
    pub deprecated_grant_period_seconds: ::core::option::Option<i32>,
    #[prost(int32, optional, tag = "2")]
    pub deprecated_activate_period_seconds: ::core::option::Option<i32>,
    #[prost(message, optional, tag = "3")]
...
pub struct TagMetadata {
    #[prost(oneof = "tag_metadata::MetadataOneOf", tags = "3, 4")]
    pub metadata_one_of: ::core::option::Option<tag_metadata::MetadataOneOf>,
}
...
pub struct Payload {
    ...
    pub back_device_choices_response: ::core::option::Option<BackDeviceChoicesResponse>,
...
pub struct Review {
    ...
    #[prost(bytes = "vec", optional, tag = "2")]
    pub url: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(string, optional, tag = "3")]
...
pub struct ServerResponse {
    #[prost(message, optional, tag = "2")]
    pub error: ::core::option::Option<server_response::Error>,
}
